...
Si interpola linearmente la frequenza in funzione della radice quadrata della tensione, assumendo un'incertezza di $\sigma_f = \qty{1.0}{Hz}$ sulle misure di frequenza, seguendo lo stesso criterio adottato per le misure effettuate nella precedente sezione dell'esperienza.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Immagini/T.png}
...
Il coefficiente angolare interpolato è $k_{misurato} = \qty{34.65 \pm 0.27}{Hz.N^{-\frac{1}{2}}}$, mentre quello ricavato dalla relazione \eqref{eq:frequenze} è $k_{teorico} = \qty{33.2 \pm 1.8}{Hz.N^{-\frac{1}{2}}}$. Tramite la relazione \eqref{eq:t_test} si è ottenuto $t_0 = 0.79$, che corrisponde a una probabilità di accordo del 43.0\%.
\newpage