...
I dati raccolti sono mostrati in Tabella 2.
...
Il test del $\chi^2$ restituisce un $\Tilde{\chi}_o^2$=1.10, che per sette gradi di libertà corrisponde ad una probabilità di accordo del 36.2\%.
...
Tramite la relazione \eqref{eq:t_test} si ottiene $t_0 = 0.79$, che corrisponde a una compatibilità tra le misure del 43.0\%.