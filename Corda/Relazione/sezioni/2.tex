...
\end{equation}
 ...
 A partire da $k_1$, tramite la relazione \eqref{eq:frequenze}, si ottiene $v_1 = \qty{22.7 \pm 0.5}{\meter\per\second}$. Tale valore si può confrontare con la velocità di propagazione $v'_1 = \qty{24.7 \pm 1.2}{\meter\per\second}$, prevista dalle misure di massa lineare $\mu$ e tensione $\tau = m_{\text{supporto}}\cdot g$, tramite la relazione:
...
Il t-test restituisce $t_0 = 1.54$, che indica una compatibilità del 12.4\%.
