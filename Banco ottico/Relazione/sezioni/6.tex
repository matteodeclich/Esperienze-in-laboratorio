...
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}\textbf{Distanza}\\(\unit{mm})\end{tabular}} & \multicolumn{2}{c}{\textbf{Misura 1}} & \multicolumn{2}{c}{\textbf{Misura 2}} \\
\cmidrule(r){2-3} \cmidrule(l){4-5}
 & $p$ (\unit{mm}) & $q$ (\unit{mm}) & $p$ (\unit{mm}) & $q$ (\unit{mm}) \\
\midrule
...
Sono poi stati raccolti i dati sugli ingrandimenti per quattro distanze tra sorgente e schermo, che vengono riportati nella tabella sottostante.\\ 
