...
$$\sin\theta_{inc}>\sin\theta_{critico}=n_1\sin\theta_{\text{rif}}=1$$ il che è impossibile. Quindi per angoli maggiori di $\theta_{critico}$  non si ha più rifrazione, ma riflessione.
