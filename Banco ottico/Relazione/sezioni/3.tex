...
Infine, è stato misurato l'angolo critico sul lato curvo, ovvero l'angolo di incidenza per cui si ha la riflessione totale, che si verifica quando il raggio luminoso viene rifratto parallelamente al lato piatto della lente e svanisce.\\
...
$$\sin\theta_{inc}=\frac{n_2}{n_1}\sin\theta_{inc}=n_1\sin\theta_{\text{rif}}>1$$ il che è impossibile. Quindi per angoli maggiori di $\theta_{critico}$  non si ha più rifrazione, ma riflessione.
