...
È stata fatta quindi un'interpolazione lineare passante per l'origine tra $\sin\theta_{\text{inc}}$ e $\sin\theta_{\text{rif}}$ dalla quale si ricava k=0.66 $\pm$ 0.01. Il test di adattamento del $\chi^2$ restituisce un p-value del $99.3\%$, il che indica un'ottima compatibilità con il modello teorico.
